...
public class Exercicio04cap3 {
	...
	desconto = 10.0;
	Double DescontoDez = total * desconto / 100;
	
	System.out.println("O total é de: " + (total - DescontoDez));
	}else 
		System.out.println(" O total é de: " + quantidadeProduto * valorProduto);
